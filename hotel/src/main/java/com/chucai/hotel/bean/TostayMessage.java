...
public class   TostayMessage implements Serializable {
    ...
    public static class DataDTO {
        ...
        private String memo;
        private String enter_time_plan;
        ...
        public String getEnter_time_plan() {
            return enter_time_plan;
        }

        public void setEnter_time_plan(String enter_time_plan) {
        ...
        public static class RoomInfoDTO {
            ...
            public static class RoomPricesDTO {
                private String date;
                private int room_price;
                private int original_room_price;
            ...
            public static class RoomServiceListDTO {
                private int id;
                private int room_type_id;
        ...
        public static class RoomListDTO {
            ...
            private List<UserListDTO> enter_msg;
            ...
            public List<UserListDTO> getEnter_msg() {
                return enter_msg;
            }

            public void setEnter_msg(List<UserListDTO> enter_msg) {
            ...
            public static class PriceOriginalDTO {
                private String date;
                private int price;
