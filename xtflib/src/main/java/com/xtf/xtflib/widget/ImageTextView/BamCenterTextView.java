...
import com.xtf.xtflib.widget.bam.BamTextView;


public class BamCenterTextView extends BamTextView {
    private int drawableWidth;
    private int drawableHeight;



    public BamCenterTextView(Context context) {
        super(context);

    }

    public BamCenterTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    ...
    public BamCenterTextView(Context context, AttributeSet attrs, int defStyleAttr) {
