...
public class DrawableCenterRadioButton extends AppCompatRadioButton implements Cloneable{
    ...
    private void init(AttributeSet attrs) {
        ...
        TypedArray array = getContext().obtainStyledAttributes(attrs, R.styleable.DrawableTextView);
        ...
        int defVal= 25;
        widths[0] = array.getDimensionPixelSize(R.styleable.DrawableTextView_leftDrawableWidth,defVal );
        widths[1] = array.getDimensionPixelSize(R.styleable.DrawableTextView_topDrawableWidth, defVal);
        widths[2] = array.getDimensionPixelSize(R.styleable.DrawableTextView_rightDrawableWidth, defVal);
        widths[3] = array.getDimensionPixelSize(R.styleable.DrawableTextView_bottomDrawableWidth, defVal);

        heights[0] = array.getDimensionPixelSize(R.styleable.DrawableTextView_leftDrawableHeight, defVal);
        heights[1] = array.getDimensionPixelSize(R.styleable.DrawableTextView_topDrawableHeight, defVal);
        heights[2] = array.getDimensionPixelSize(R.styleable.DrawableTextView_rightDrawableHeight, defVal);
        heights[3] = array.getDimensionPixelSize(R.styleable.DrawableTextView_bottomDrawableHeight, defVal);

        array.recycle();
    }

    public void setDrawable(@DrawableCenterTextView.DrawGravity int gravity, Drawable drawable, int width, int height) {
