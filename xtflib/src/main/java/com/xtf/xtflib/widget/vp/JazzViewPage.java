package com.xtf.xtflib.widget.vp;
...
public class JazzViewPage extends ViewPager {
    ...
    public JazzViewPage(Context context) {
        this(context, null);
    }

    @SuppressWarnings("incomplete-switch")
    public JazzViewPage(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//		mRight = getChildAt(position+1);
    ...
    class OutlineContainer extends FrameLayout implements Animatable {
        ...
        private void init() {
            ...
            mOutlinePaint.setStrokeWidth(ScreenUtils.dip2px(getContext(), 2));
            mOutlinePaint.setColor(Color.BLUE);
            mOutlinePaint.setStyle(Paint.Style.STROKE);

            int padding = (int) ScreenUtils.dip2px(getContext(), 10);
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            int offset = (int) ScreenUtils.dip2px(getContext(), 5);
